...
def dfs(v, dept):
    ...
    if visited==O_num:
        ...
        return
    if (min_num<= v and ((v>=0 and visited[1]==0 and visited[3]==0) or (v<0 and visited[1]==0 and visited[2]==0))) and (max_num>=v and ((v>=0 and visited[0]==0 and visited[2]==0) or (v<0 and visited[0]==0 and visited[3]==0))):
        print(v,dept,visited)
        return
    for i in range(4):
